...
import { Layout, Menu, Form, Input, Button, Typography, Card, Divider, Tag } from 'antd';
import { UserOutlined, ArrowLeftOutlined, TeamOutlined, KeyOutlined, GoogleOutlined } from '@ant-design/icons';
...
export default function Manager() {
  ...
  const menuItems: MenuProps['items'] = [
    ...
    { key: '3', icon: <KeyOutlined />, label: 'Quản lý phân quyền' },
    { type: 'divider' },
